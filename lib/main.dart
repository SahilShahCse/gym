...
import 'package:gym/providers/DietPlanProvider.dart';
import 'package:gym/providers/MemberProvider.dart';
import 'package:gym/providers/OwnerProvider.dart';
import 'package:gym/providers/PaymentProvder.dart';
import 'package:gym/providers/TrainerProvider.dart';
import 'package:gym/providers/WorkoutPlanProvider.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => DietPlanProvider()),
